...
#elif MB(MKS_ROBIN_NANO_FRANKIE)
  #include "stm32f1/pins_MKS_ROBIN_NANO_FRANKIE.h"  // STM32F1                              env:mks_robin_nano_v1v2 env:mks_robin_nano_v1v2_maple env:mks_robin_nano_v1v2_usbmod
