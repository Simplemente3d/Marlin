...
#define STRING_CONFIG_H_AUTHOR "Simplemente 3D" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "S3D KP3S Pro"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 122.91  // GR rilevati con Pronterface sulla mia stampante
  #define DEFAULT_bedKi 21.05   // GR rilevati con Pronterface sulla mia stampante
  #define DEFAULT_bedKd 478.54  // GR rilevati con Pronterface sulla mia stampante
